...
def ray_trace(parameters):
    # -------- Assembly Parameters -------- #
    alpha_x,alpha_y = parameters
    ...
    leaf_width = 0.75
    N = 10000 # Number ophotons included in the interaction
    spec_prob = 0.01
    abs_spec = 0.01
...
guess = [0.8,0.05]
result = optimize.minimize(ray_trace,guess, method='L-BFGS-B', bounds =[(0.751,0.9),(0.05,0.2)],options={'eps':0.01}) 
print(result)
if result.success:
